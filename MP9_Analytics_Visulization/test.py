...
student = {
    "submitterEmail": "qinq2@illinois.edu", #<Your coursera account email>
    "secret": "jdjhDKdsEv0TYppt" #<Your secret token from coursera>
}
...
viz0CsvPath = "/Users/qinqin/MP9/mp9-viz0.csv" #<Filepath for your tableau viz0 csv/tsv file>
viz1CsvPath = "/Users/qinqin/MP9/mp9-viz1.csv" #<Filepath for your tableau viz1 csv/tsv file>
viz2CsvPath = "/Users/qinqin/MP9/mp9-viz2.csv" #<Filepath for your tableau viz2 csv/tsv file>
